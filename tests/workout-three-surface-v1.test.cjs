...
assert.ok(flow.includes("VERSION='garang-workout-flow-v1.2.0-single-surface'"),'Workout flow must expose a canonical structural version');
...
assert.ok(html.includes('garang-workout-flow-v1.js?v=1.2.0-single-surface'),'index must load the merged single-surface Workout flow version');
