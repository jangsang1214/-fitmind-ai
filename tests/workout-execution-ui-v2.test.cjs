...
assert.ok(polish.includes('data-garang-classical-model="5"')&&polish.includes('g5-silhouette')&&polish.includes('function v5SideSVG')&&polish.includes('data-garang-anatomy-v5="side"')&&polish.includes('data-g3-view="side"'),'Body Model v5 must use a continuous anatomy silhouette and dedicated FRONT / SIDE / BACK geometry while preserving interactive muscle zones');
assert.ok(polish.includes("viewBox=\"0 0 260 520\"")&&polish.includes('g5-hand-detail')&&polish.includes('g5-foot-detail'),'Body Model v5 must raise the proportion/detail floor beyond the segmented mannequin model');
