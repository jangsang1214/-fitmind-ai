...
assert.ok(runtime.includes("canonicalSave.hidden=true")&&runtime.includes("workout-canonical-save"),'legacy text save control must stay hidden while remaining the canonical persistence owner');
