...
const context={window,document,localStorage,MutationObserver:function(){this.observe=()=>{};},setTimeout(){return 0;},clearTimeout(){},requestAnimationFrame(){return 0;},console,JSON,Date,Math,Object,Array,String,Number,Map,Set,Promise,encodeURIComponent,location:{reload(){}}};
...
const merged=Recovery.combineHistory(current,[{state:backup}],cloudHistory,null),counts=Recovery.counts(merged);
