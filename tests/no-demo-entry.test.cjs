...
assert.match(wanted,/JUDGING MODE · SAMPLE DATA/);
...
console.log('commercial auth + Wanted derivative judging contract: PASS',JSON.stringify({browserFiles:browserFiles.length}));
