...
for(const p of ['./03_styles/runtime/styles.css','./01_app/app.js','./06_features/ui/i18n/translations.js','./06_features/ui/i18n/runtime.js','./05_assets/garang-logo-exact.png'])assert.ok(html.includes(p),p);
...
assert.match(authCss,/html\[lang="en"\] \.auth-copy h1/);assert.match(authCss,/Cormorant Garamond/);assert.match(authCss,/white-space:nowrap/);
