...
(async()=>{
 ...
 try{
  ...
  await page.waitForFunction(()=>window.GarangSimplifiedShell?.version==='1.1.0'&&window.GarangCoreLoopV1?.version==='garang-core-loop-v1.0.0'&&window.GarangRouter?.version==='garang-router-v1.3.0'&&window.GarangScreens?.version==='1.2.1',{timeout:7000});
