...
(async()=>{
 ...
 try{
  ...
  await page.waitForFunction(()=>window.GarangProductConsolidationV1?.version==='garang-product-consolidation-v1.1.0'&&window.GarangSimplifiedShell&&window.GarangRouter&&window.GarangTodaySingleNextActionV1&&window.GarangGoalAlignment&&window.GarangCoreLoopV1,null,{timeout:8000});
