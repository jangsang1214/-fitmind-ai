...
assert.ok(runtime.indexOf('GarangPhotoEvidence?.deleteMany')<runtime.indexOf('Policy.deleteLocalAccountKeys'),'Photo Evidence must be deleted before local account keys are removed');
