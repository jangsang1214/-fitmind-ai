...
assert.ok(html.includes('garang-app-chrome-fix-v1.css?v=1.1.0-ios-layout'),'iOS-safe chrome CSS must be cache-busted in the live shell');
...
assert.ok(chrome.includes('#main[data-garang-screen]:not([data-garang-screen="coach"])'),'ordinary screens must be separated from the fixed Coach workspace');
