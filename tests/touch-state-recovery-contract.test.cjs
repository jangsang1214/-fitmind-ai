...
const html=fs.readFileSync(path.join(root,'index.html'),'utf8'),sanitizer=fs.readFileSync(path.join(root,'06_features/ui/runtime/garang-state-sanitizer-v1.js'),'utf8'),sync=fs.readFileSync(path.join(root,'06_features/ui/runtime/garang-sync-durability-v1.js'),'utf8'),route=fs.readFileSync(path.join(root,'06_features/ui/runtime/garang-auth-route-reconcile-v1.js'),'utf8'),chrome=fs.readFileSync(path.join(root,'03_styles/runtime/garang-app-chrome-fix-v1.css'),'utf8'),polish=fs.readFileSync(path.join(root,'03_styles/runtime/garang-polish-v3.css'),'utf8'),firebaseConfig=fs.readFileSync(path.join(root,'07_config/firebase-config.js'),'utf8'),sw=fs.readFileSync(path.join(root,'sw.js'),'utf8'),swRuntime=fs.readFileSync(path.join(root,'02_core/sw-runtime.js'),'utf8'),swUpdater=fs.readFileSync(path.join(root,'06_features/ui/runtime/garang-sw-update-v2.js'),'utf8');
