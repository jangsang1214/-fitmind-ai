...
assert.ok(runtime.includes("VERSION='garang-coach-decision-v1.2'"),'compact Coach decision runtime version must be active');
...
assert.ok(runtime.includes('min-height:52px'),'mobile decision strip must stay compact');
...
assert.ok(html.includes('garang-coach-decision-v1.js?v=1.2.0'),'index must bust the old Coach decision asset cache');
