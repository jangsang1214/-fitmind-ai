...
function mount(root){
  function ensureCoachActionLayoutStyle(){
    ...
    const style=doc.createElement('style');style.id='garang-core-loop-action-layout-style';style.textContent='.g2-chat-main.garang-has-decision-card{grid-template-rows:auto auto auto minmax(0,1fr) auto!important}.g2-chat-main.garang-has-decision-card>.gcl-coach-actions,.g2-chat-main.garang-has-decision-card>.gcl-context-actions{grid-row:3!important}.g2-chat-main.garang-has-decision-card>.g2-chat-scroll{grid-row:4!important}.g2-chat-main.garang-has-decision-card>.g2-composer-wrap{grid-row:5!important}.gcl-context-actions{margin-top:0;padding:14px 0 4px;border-top:1px solid rgba(242,239,233,.08)}.gcl-context-label{margin-bottom:8px;color:#4fae92;font-size:8px;letter-spacing:.16em}.gcl-context-actions>div:last-child{display:flex;gap:8px;flex-wrap:wrap}.gcl-context-actions button{min-height:38px;padding:8px 13px;border:1px solid rgba(79,174,146,.25);border-radius:999px;background:transparent;color:inherit}.gcl-goal-head{display:flex;align-items:end;justify-content:space-between;gap:16px;margin-top:20px;padding-top:18px;border-top:1px solid rgba(242,239,233,.08)}.gcl-goal-head span{display:block;color:#4fae92;font-size:8px;letter-spacing:.16em}.gcl-goal-head strong{display:block;margin-top:4px;font:400 42px/.9 var(--g2-display,"Cormorant Garamond",Georgia,serif)}.gcl-goal-head>small{color:#a5a59f;font-size:10px}.gcl-goal-rows{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:8px;margin-top:14px}.gcl-goal-row{min-width:0;padding:11px 10px;border-top:1px solid rgba(242,239,233,.1)}.gcl-goal-row>span{display:block;color:#a5a59f;font-size:10px}.gcl-goal-row>strong{display:block;margin-top:7px;font-size:21px;font-weight:450}.gcl-goal-row>small{display:block;margin-top:7px;color:#7c807b;font-size:9px;line-height:1.4;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.gcl-goal-note{margin:12px 0 0;color:#7c807b;font-size:9px;line-height:1.5}.gcl-streak-details{margin-top:13px}.gcl-streak-details summary{color:#7c807b;font-size:9px;cursor:pointer}@media(max-width:700px){.gcl-goal-rows{grid-template-columns:repeat(2,minmax(0,1fr))}}';doc.head.appendChild(style);
  }
