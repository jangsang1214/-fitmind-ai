/* GARANG Coach Decision UI v1.5
   Decision-first hierarchy for Coach: judgment -> reason -> canonical next action.
...
const VERSION='garang-coach-decision-v1.5-canonical-next';
...
.garang-decision-details{padding:11px 14px 13px}.garang-decision-details[hidden]{display:none!important}.garang-decision-evidence-label{display:block;margin:0 0 7px;color:#747a75;font-size:8px;letter-spacing:.12em}.garang-decision-signals{display:flex;gap:6px;flex-wrap:wrap}.garang-decision-signals span{font-size:9px;padding:5px 7px;border:1px solid rgba(255,255,255,.09);border-radius:999px;color:#8f958f}.garang-decision-next{margin-top:10px;padding-top:9px;border-top:1px solid rgba(255,255,255,.065)}.garang-decision-next span{display:block;margin-bottom:4px;color:#747a75;font-size:8px;letter-spacing:.12em}.garang-decision-next strong{display:block;color:#c9d8d2;font-size:11px;font-weight:650}.garang-decision-next p{margin:3px 0 0;color:#858c87;font-size:9px;line-height:1.45}.garang-decision-foot{display:flex;align-items:center;justify-content:space-between;gap:10px;margin-top:10px;font-size:9px;color:#727873}
...
function render(){
 ...
 const canonical=canonicalNext(Bridge);
 ...
 try{window.dispatchEvent(new CustomEvent('garang:coach-decision-rendered',{detail:{card,root,nextAction:canonical}}));}catch{}
}
