...
.gtf-checkin-access{appearance:none;width:100%;min-height:64px;display:grid;grid-template-columns:minmax(0,1fr) auto;gap:4px 12px;align-items:center;margin:12px 0 0;padding:11px 0;border:0;border-top:1px solid rgba(241,237,228,.10);border-bottom:1px solid rgba(241,237,228,.07);border-radius:0;background:transparent;color:#f1ede4;text-align:left;cursor:pointer;box-shadow:none}
.gtf-checkin-access>span{font-size:7px;font-weight:600;letter-spacing:.16em;color:#d65340}.gtf-checkin-access>strong{font-size:12px;font-weight:600;letter-spacing:-.01em;color:rgba(241,237,228,.88)}.gtf-checkin-access>small{grid-column:2;grid-row:1/3;font-size:8px;line-height:1.35;color:rgba(241,237,228,.34);text-align:right}.gtf-checkin-access:focus-visible{outline:1px solid rgba(214,83,64,.72);outline-offset:3px}.gtf-checkin-access:active{opacity:.78}
...
`;document.head.appendChild(style);
  ...
  function pinEditorialCheckin(button){
    ...
    button.style.setProperty('border-top','1px solid rgba(241,237,228,.10)','important');
