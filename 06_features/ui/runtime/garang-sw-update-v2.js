...
function loadStateEventDurability(){
  ...
  const script=document.createElement('script');
  script.src='./06_features/ui/runtime/garang-state-event-durability-v1.js?v=1.1.0';
...
function loadMobileCheckinPlannerShortcut(){
  if(window.GarangMobileCheckinPlannerShortcutV1||document.querySelector('script[data-garang-mobile-checkin-planner-shortcut-v1]'))return;
  const script=document.createElement('script');
  script.src='./06_features/ui/runtime/garang-mobile-checkin-planner-shortcut-v1.js?v=1.0.0';
  script.dataset.garangMobileCheckinPlannerShortcutV1='1';
  script.async=false;
  document.head.appendChild(script);
}
...
loadMobileCheckinPlannerShortcut();
