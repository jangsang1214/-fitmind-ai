...
<section class="card meal-scan-card">
 <div class="meal-scan-header"><div><span class="eyebrow">MEAL SCAN</span><h3>식사를 사진으로 기록하세요</h3><p>GARANG DB를 먼저 쓰고, 없으면 신뢰 가능한 웹 출처를 찾아 계산합니다.</p></div>${scan?.url?'<button id="pickMealScan" class="ghost">사진 변경</button>':''}</div>
