...
function bindNutrition(){
  ...
  $('applyAdaptiveNutritionTarget')?.addEventListener('click',applyAdaptiveNutritionTarget);$('resetAdaptiveNutritionTarget')?.addEventListener('click',resetAdaptiveNutritionTarget);
}
