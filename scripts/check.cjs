...
const result={timestamp:new Date().toISOString(),status:failures.length?'FAIL':'PASS',counts,failures,scope:'Frozen runtime boot order and ownership v2, schema/error core contracts, JS/JSON syntax, active entry assets, shell IDs, i18n wiring, canonical owner names, no loose root duplicates or retired core runtimes.'};
