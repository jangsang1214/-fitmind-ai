...
assert.equal(origins.has('https://garang-wanted-2026-jangsang1214.vercel.app'),true);
...
let wantedNext=false;const wanted=response();middleware({method:'POST',headers:{origin:'https://garang-wanted-2026-jangsang1214.vercel.app'},get:key=>key==='origin'?'https://garang-wanted-2026-jangsang1214.vercel.app':''},wanted,()=>{wantedNext=true;});assert.equal(wantedNext,true);assert.equal(wanted.headers['Access-Control-Allow-Origin'],'https://garang-wanted-2026-jangsang1214.vercel.app');
