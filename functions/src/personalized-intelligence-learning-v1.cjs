...
module.exports=Object.freeze({VERSION,RESPONSE_MODEL_VERSION,POLICY_VERSION,buildEpisodes,buildResponseModel,evaluateCandidates,build,compactForContext,durationBand,intensityBand,outcomeScore});
