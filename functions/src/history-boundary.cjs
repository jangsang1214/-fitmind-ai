...
module.exports={VERSION,DOMAINS,COLLECTIONS,rows,rowStamp,recordId,normalizeRecord,tombstonesFor,mergeRows,mergeStateWithHistory,recordFromDoc,stableStringify,fnv1a};
