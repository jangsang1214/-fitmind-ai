...
const CACHE='garang-major-update-complete-v1';
const ASSETS=[
  ...
  './records.js','./adapters.js','./features.js','./firebase-config.js','./services-config.js',
  './styles.css','./garang-v10-release.css','./garang-planner-v10.css','./final.css',
